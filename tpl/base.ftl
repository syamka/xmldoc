...
<head>
    ...
    <script type="text/javascript">
        ...
        dataLists = {
            ...
            preconditions: [
                    <#list preconditions as precondition>
                        "${precondition}",
                    </#list>
                ],
	...
	<tr>
		<td>
            <div id="filters" style="height: 220px;">
                <table>
                    <tr>
                        <td style="text-align:right;">precondition:</td>
                        <td><input id="filter_preconditions" type="text" style="float:left" /> <a href="#" class="close" style="display: none;" onclick="$('#filter_preconditions').val(''); doFilters(); $(this).hide(); return false;"><span class="ui-icon ui-icon-close" ></span></a></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;">execution:</td>
                        <td><input id="filter_executions" type="text"  style="float:left"/> <a href="#" class="close" style="display: none;" onclick="$('#filter_executions').val(''); doFilters(); $(this).hide(); return false;"><span class="ui-icon ui-icon-close" ></span></a></td>
                    </tr>
        ...
        <div id="toggle_filters">
            ...
            <br />
            <input id="filter_actions" type="text" style="width:95%"/>
            <#include "actionstree.ftl">
		<td>
		<td style="width:100%">
